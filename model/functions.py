...
class one_step_rnn(nn.Module):
    ...
    def __init__(self, input_channels, num_features, activation, 
                 kernel=3, batch=8, Height=256, Width=256, scale=4):
...
class ConvLSTMCell(nn.Module):
    ...
    def __init__(self, shape=(4, 64, 64), num_features=192, kernel=3,  
                 input_channels=192, forget_bias=1.0, activation=nn.Tanh, 
